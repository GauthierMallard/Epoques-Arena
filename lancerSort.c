...
void lancerSort(t_joueur* lanceur, int choixSort, t_cases carte[LIGNES][COLONNES], t_joueur* joueurs, int* nbjoueur)
{
    ...
    if(mouse_b&1)
    {
        ...
        Type 3 : s’applique dans une zone sous forme de croix. Inflige les effets à l’adversaire. Effet 1 = pv effet2 = pm
        Type 1 : s’applique dans une zone circulaire. Inflige les effets à l’adversaire. Effet 1 = pv effet 2 = pm
        Type 4 : s’applique dans une zone sous forme de croix. Permet de se régénérer. Effet 1 = pv perdus effet 2 = pv gagnes.
        Type 2 : s’applique dans une zone circulaire. Permet de se régénérer. Effet 1 = pv perdus effet 2 = pv gagnés.
        */
        ...
        else if(lanceur->classeJ.sorts[choixSort].type == 3)
        {
            if(alea1 < 3)
            {
        ...
        else if(lanceur->classeJ.sorts[choixSort].type == 1)
        {
            if(alea1 < 3)
            {
                victime->pv=(victime->pv - lanceur->classeJ.sorts[choixSort].effet1);
        ...
        else if(lanceur->classeJ.sorts[choixSort].type == 4)
        {
            if(alea1 < 3)
            {
                victime->pv=(victime->pv - lanceur->classeJ.sorts[choixSort].effet1);
        ...
        else if(lanceur->classeJ.sorts[choixSort].type == 2)
        {
            if(alea1 < 3)
            {
                victime->pv=(victime->pv - lanceur->classeJ.sorts[choixSort].effet1);
